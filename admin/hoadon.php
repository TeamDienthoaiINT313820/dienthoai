...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($connect,"SELECT * FROM hoadon ORDER by mahd DESC  LIMIT $from, $max_results"); 
...
<div id="phantrang_sp">
	...
	<?php
			...
			$total_results = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM hoadon"));  
