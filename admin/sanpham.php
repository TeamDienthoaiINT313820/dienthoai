...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($connect,"SELECT * FROM sanpham inner join danhmuc on sanpham.madm=danhmuc.madm ORDER by idsp  LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			$total_results = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM sanpham"));  
