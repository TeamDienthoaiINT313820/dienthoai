...
<?php
	...
	//	$hinhanh=$_POST['hinhanh'];
		...
		$madm=$_POST['madm'];
		$insert="INSERT INTO sanpham(tensp,hinhanh,mau,chitiet,soluong,daban,gia,khuyenmai1,khuyenmai2,madm,ngaycapnhat,trangthai) VALUES('$ten_sanpham', '$file__name__', '$mau', '$chitiet', '$soluong','0', '$gia', '$khuyenmai1', '$khuyenmai2', '$madm', '$ngay','0')";
      ...
      <table>
            ...
            <tr>
            	<td>Mã DM</td><td>
                    ...
                    <?php
						$show = mysqli_query($connect,"SELECT * FROM danhmuc WHERE dequi=0");
						while($show1 = mysqli_fetch_array($show))
						{
							$madm1 = $show1['madm'];	
							$tendm1 = $show1['tendm'];
							echo "<option value='".$madm1."'>".$tendm1."</option>";	
								$show2 = mysqli_query($connect,"SELECT * FROM danhmuc WHERE dequi='".$madm1."'");
