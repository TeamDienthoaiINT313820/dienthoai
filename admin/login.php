...
if(isset($_POST['login']))
{
    ...
    $sql_check = mysqli_query($connect,"select * from nguoidung where username = '$username'");
    ...
    {
        $sql_check2 = mysqli_query($connect,"select * from nguoidung where username = '$username' and password = '$password'");
