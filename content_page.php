						...
						<h2><?php echo $row['tendm']?></h2>
							<div class="sanphamcon">
								...
								<?php
										...
										$total_results = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM sanpham  WHERE madm='{$_GET['madm']}'"));  
										...
										if($page > 1){  
										$prev = ($page - 1);  
										echo "<a href=\"".$_SERVER['PHP_SELF']."?madm=".$_GET['madm']."&page=1\"><button class='trang'><<</button></a>&nbsp;";  
										echo "<a href=\"".$_SERVER['PHP_SELF']."?madm=".$_GET['madm']."&page=$prev\"><button class='trang'><</button></a>&nbsp;";  
										}  
										...
										if($page < $total_pages){  
										$next = ($page + 1);  
										echo "<a href=\"".$_SERVER['PHP_SELF']."?madm=".$_GET['madm']."&page=$next\"><button class='trang'>></button></a>&nbsp;";  
										echo "<a href=\"".$_SERVER['PHP_SELF']."?madm=".$_GET['madm']."&page=$total_pages\"><button class='trang'>>></button></a>&nbsp;";  
										}  
										echo "</center>";  		
